...
public class MyShiroFilterFactoryBean implements FactoryBean, BeanPostProcessor {
	...
	private Logger logger = LoggerFactory.getLogger(MyShiroFilterFactoryBean.class);
    ...
    public Map<String, String> getFilterChainDefinitionMap() {
    	Set<String> keys = filterChainDefinitionMap.keySet();
        for(String key : keys) {
        	logger.info("key:" + key + "  value:" + filterChainDefinitionMap.get(key));
        }
